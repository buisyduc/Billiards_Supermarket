        ...
        <header>
            ...
            <div class="header_nav grid wide">
                <ul class="header_navs1">
                    ...
                    <li class="position-relative hoverproduct"><a href="index.php?act=listsanpham">SẢN PHẨM</a>
                        ...
                        <div class="product_navs2 navs2">
                            ...
                            foreach ($listchatlieu as $key => $chatlieu) {
                                extract($chatlieu); ?>
                                <ul>
                                    <li><a href="index.php?act=listsanpham&id_chatlieu=<?= $id_chatlieu ?>" class="product_navs2-title product_navs2-gold">Gậy <?= $ten_chatlieu ?></a></li>
                                    <?php
                    ...
                    <li class="position-relative hoverjewewedding"><a href="index.php?act=listsanpham&id_chatlieu=3">DANH MỤC GẬY</a><i class="ti-angle-down"></i>
                        <div class="navs2 jewewedding_navs2">
                            <ul>
                                <?php
                                foreach ($listmathang_mathang as $key => $mathang) {
                                    extract($mathang); ?>
                                    <li><a href="index.php?act=listsanpham&id_chatlieu=3&id_mathang=<?= $id_mathang ?>"><?= $ten_mathang ?> </a></li>
                                <?php   }
                                ?>
                            </ul>
                        </div>
